...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
  ...
  <div class="container my-4">
    <iframe height="620px" width="100%" src="https://www.youtube.com/embed/ur6I5m2nTvk?autoplay=1" frameborder="0" allowfullscreen></iframe>
      <p style="font-size: 20px">#01 React Introduction | What is React? | React Native Dev</p>
