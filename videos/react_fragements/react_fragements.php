...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
  ...
  <div class="container my-4">
    <iframe height="620px" width="100%" src="https://www.youtube.com/embed/bHdh1T0-US4?autoplay=1" frameborder="0" allowfullscreen></iframe>
      <p style="font-size: 20px">React Fragements | What is React Fragements? | React Native Dev</p>
    <p><b style="padding-right: 928px; color: grey">2M Views</b> &nbsp;&nbsp;&nbsp;<i class="fa-regular fa-thumbs-up me-1" style="color: grey"></i> 10M &nbsp;&nbsp;&nbsp;<i class="fa-regular fa-thumbs-down me-1" style="color: grey"></i> 10K &nbsp;&nbsp;&nbsp;<i class="fa-solid fa-share me-1" style="color: grey"></i> Share &nbsp;&nbsp;&nbsp;<i class="fa-regular fa-bookmark me-1" style="color: grey"></i> Save</p>
  </div>
  <div class="container">
  ...
  <div class="container">
    ...
    <div class="details">
        <div class="author">
            <img src="../asset/image/react_icon.png" alt="" style="border: 1px #FFCC00 solid"/>
        </div>
        <div class="title">
          <a href="" style="color: black">
              React Native Dev <i class="bi bi-check-circle-fill"></i>
          </a>
          <span> 6M Subscriber </span>
        </div>
      </div>
    </div>
  </div>
  <div class="container">
    <p>We know that we make use of the render method inside a component whenever we want to render something to the screen.<span id="dots">...</span><p id="more">We may render a single element or multiple elements, though rendering multiple elements will require a 'div' tag around the content as the render method will only render a single root node inside it at a time.</p>
    </p>
