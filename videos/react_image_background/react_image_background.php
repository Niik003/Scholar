...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
  ...
  <div class="container my-4">
    <iframe height="620px" width="100%" src="https://www.youtube.com/embed/xDW6GCD1pxA?autoplay=1" frameborder="0" allowfullscreen></iframe>
      <p style="font-size: 20px">React Image Background | How to create fullscreen image in React Native? | React Native</p>
  ...
  <div class="container">
    ...
    <div class="details">
        <div class="author">
            <img src="../asset/image/react_native_icon copy.jpg" alt="" style="border: 1px #FFCC00 solid"/>
        </div>
        <div class="title">
  ...
  <div class="container">
    <p>Approach: In this article, we will see that how to set background Image in react-native.<span id="dots">...</span><p id="more">In our project, we will simply set a background image and show a text input on top of it. Step 2: Create a components folder inside your project. Inside the components, folder create a file BackgroundImage.</p>
    </p>
