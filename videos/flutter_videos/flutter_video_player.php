...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
    <div class="container">
      ...
      <div class=" collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ms-auto ">
          ...
          <li class="nav-item">
            <a class="nav-link mx-2 text-uppercase" href="../videos.php">Videos</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container my-4">
    <iframe height="620px" width="100%" src="https://www.youtube.com/embed/OXQ5ee6p9ZA?autoplay=1" frameborder="0" allowfullscreen></iframe>
    <p style="font-size: 20px">Flutter Video Player | How to make video player in flutter? | Flutter Dev</p>
  ...
  <div class="container">
    ...
    <div class="details">
        <div class="author">
            <img src="../asset/image/flutter1_videos" alt="" style="border: 1px #FFCC00 solid"/>
        </div>
        <div class="title">
          <a href="" style="color: black">
              Flutter Dev <i class="bi bi-check-circle-fill"></i>
          </a>
          <span> 5M Subscriber </span>
        </div>
      </div>
    </div>
  </div>
  <div class="container">
    <p>The following section contains usage information that goes beyond what is included in the documentation in order to give a more elaborate overview of the API. This is not complete as of now. You can contribute to this section by opening a pull request.<span id="dots">...</span><p id="more">You can set the playback speed on your _controller (instance of VideoPlayerController) by calling _controller.setPlaybackSpeed. setPlaybackSpeed takes a double speed value indicating the rate of playback for your video. For example, when given a value of 2.0, your video will play at 2x the regular playback speed and so on. To learn about playback speed limitations, see the setPlaybackSpeed method documentation. Furthermore, see the example app for an example playback speed implementation.</p>
    </p>
