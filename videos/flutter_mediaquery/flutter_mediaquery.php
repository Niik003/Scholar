...
<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
  ...
  <div class="container my-4">
    <iframe height="620px" width="100%" src="https://www.youtube.com/embed/A3WrA4zAaPw?autoplay=1" frameborder="0" allowfullscreen></iframe>
      <p style="font-size: 20px">Flutter MediaQuery | How to add mediaquery widget in flutter application? | Flutter</p>
  ...
  <div class="container">
    <p>During the process of developing an app for both phones and tablets, it is standard practice to have different UI layouts for different screen sizes for a better user experience. If the user has a preference set for different font sizes or wants to curtail animations.<span id="dots">...</span><p id="more">This is where MediaQuery comes into action, you can get information about the current device size, as well as user preferences, and design your layout accordingly. MediaQuery provides a higher-level view of the current app’s screen size and can also give more detailed information about the device and its layout preferences. In practice, MediaQuery is always there. It can simply be accessed by calling MediaQuery.of in the build method.</p>
    </p>
